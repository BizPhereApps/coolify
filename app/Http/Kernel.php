...
use App\Http\Middleware\EnforceHostRouting;
use App\Http\Middleware\PreventRequestsDuringMaintenance;
use App\Http\Middleware\RedirectIfAuthenticated;
use App\Http\Middleware\RequireNolbaseAdmin;
use App\Http\Middleware\RequireResellerFeature;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'nolbase.admin' => RequireNolbaseAdmin::class,
        'reseller' => RequireResellerFeature::class,
        'scope.client' => ScopeClientToProject::class,
    ];
}
